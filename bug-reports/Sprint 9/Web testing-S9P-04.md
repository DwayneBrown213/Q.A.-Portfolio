# 🐞 Bug Report: S9P-04
**[Link](https://carmitdwayne-1739119879743.atlassian.net/browse/S9P-4)** to view in Jira

**Title:**<br>
*When entering invalid data into the Last name field of the "About Customer” form, the wrong error message is displayed.*
...
### **Actual Result:**  
An error message: *"Enter a valid name"* is displayed
